...
########################################################################
class Turtle01Strategy1M(CtaTemplate):  
    """Turtle交易策略"""
    ...
    def __init__(self, ctaEngine, setting):
        ...
        self.bg = BarGenerator(self.onBar,xmin=3,onXminBar=self.on3MBar,onDayBar = self.ondayBar)
    ...
    def onBar(self, bar):
        ...
        self.putEvent()
    #update day chart
    def on3MBar(self, M3Bar):
        """收到日线推送（必须由用户继承实现）"""
        self.am.updateBar(M3Bar)
        self.calcPrepare()
        # 发出状态更新事件
        self.putEvent() 
