...
class EMAC_IntraDayCommonStrategy(CtaTemplate):
    ...
    def loadIndexBar(self,dbpath):
        dfindex = pd.read_csv("/home/leon/temp/sr.csv")
        print(dbpath)
        ...
        dt = datetime.now()
        for idx,indexbar in dfordered.iterrows():
