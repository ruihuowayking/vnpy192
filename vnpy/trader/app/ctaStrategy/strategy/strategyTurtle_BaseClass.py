...
########################################################################
class Base_TurtleStrategy(CtaTemplate):
    """Turtle交易策略"""
    # With the common class in place, this is useless
    className = 'Base_TurtleStrategy'
    author = u'Leon Zhao'
    ...
    def __init__(self, ctaEngine, setting):
        """Constructor"""
        super(Base_TurtleStrategy, self).__init__(ctaEngine, setting) 
